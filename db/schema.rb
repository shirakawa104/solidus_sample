...
ActiveRecord::Schema.define(version: 20160622014657) do
  ...
  create_table "spree_bank_transfers", force: :cascade do |t|
    t.string   "email"
    t.string   "phone"
    t.string   "given_name"
  ...
  add_index "spree_bank_transfers", ["payment_method_id"], name: "index_spree_bank_transfers_on_payment_method_id"
  add_index "spree_bank_transfers", ["user_id"], name: "index_spree_bank_transfers_on_user_id"
  ...
  create_table "spree_konbinis", force: :cascade do |t|
  ...
  add_index "spree_konbinis", ["payment_method_id"], name: "index_spree_konbinis_on_payment_method_id"
  add_index "spree_konbinis", ["user_id"], name: "index_spree_konbinis_on_user_id"
  ...
  create_table "spree_pay_easies", force: :cascade do |t|
    t.string   "email"
    t.string   "phone"
    t.string   "given_name"
    t.string   "family_name"
  ...
  add_index "spree_pay_easies", ["payment_method_id"], name: "index_spree_pay_easies_on_payment_method_id"
  add_index "spree_pay_easies", ["user_id"], name: "index_spree_pay_easies_on_user_id"
  ...
  create_table "spree_web_moneys", force: :cascade do |t|
    t.string   "email"
  ...
  add_index "spree_web_moneys", ["payment_method_id"], name: "index_spree_web_moneys_on_payment_method_id"
  add_index "spree_web_moneys", ["user_id"], name: "index_spree_web_moneys_on_user_id"
